package com.javafx.mytest.forms;
...
public class MainForm extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Программный модуль учета партнёров");
    ...
    private void updateWebView() {
        ...
        if (!webEngine.getLoadWorker().getState().equals(Worker.State.SUCCEEDED)) {
        ...
        webEngine.getLoadWorker().stateProperty().addListener(
                new ChangeListener() {
                    ...
                    public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                        ...
                        JSObject window = (JSObject) webEngine.executeScript("window");
                        window.setMember("listListener", new ListListiner());
                    }
                }
        );
        webEngine.loadContent(htmlContent.toString());
